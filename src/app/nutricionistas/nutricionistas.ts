...
export class Nutricionistas implements OnInit {
  ...
  nutricionistas: Nutricionista[] = [
    { nome: 'Dra. Ana Paula Santos', especialidade: 'Diabetes e Nutrição Clínica', localidade: 'São Paulo, SP', telefone: '(11) 98765-4321', email: 'ana.santos@nutricao.com', pacientesAtendidos: 320, avaliacao: 5.0 },
    ...
    { nome: 'Dra. Mariana Costa', especialidade: 'Intolerâncias Alimentares', localidade: 'Belo Horizonte, MG', telefone: '(31) 99876-5432', email: 'mariana.costa@nutricao.com', pacientesAtendidos: 150, avaliacao: 5.0 },
    ...
    { nome: 'Dr. Henrique Alves', especialidade: 'Doença Celíaca', localidade: 'Rio de Janeiro, RJ', telefone: '(21) 98123-5676', email: 'henrique.alves@nutricao.com', pacientesAtendidos: 400, avaliacao: 3.0 },
    { nome: 'Dra. Aline Mendes', especialidade: 'Intolerâncias Alimentares', localidade: 'São Paulo, SP', telefone: '(11) 98143-4532', email: 'aline.mendes@nutricao.com', pacientesAtendidos: 452, avaliacao: 5.0 },
    ...
    { nome: 'Dr. Rafael Souza', especialidade: 'Nutrição Esportiva', localidade: 'Porto Alegre, RS', telefone: '(51) 97654-9876', email: 'rafael.souza@nutricao.com', pacientesAtendidos: 310, avaliacao: 3.0 },
    ...
    { nome: 'Dr. Marcelo Teixeira', especialidade: 'Nutrição Clínica', localidade: 'Sorocaba, SP', telefone: '(15) 98244-2222', email: 'marcelo.teixeira@nutricao.com', pacientesAtendidos: 200, avaliacao: 3.0 },
