  ...
  template: `
    ...
    <header class="app-header" *ngIf="showHeader">
      ...
      <nav class="menu">
        ...
        <a routerLink="/cardapio" routerLinkActive="ativo"><i class="icon"></i> Cardápio</a>
       <!-- <a routerLink="/lista" routerLinkActive="ativo"><i class="icon"></i> Lista de Compras</a> -->      <!--Lista de Compras desativada-->
      ...
      <div class="container-button">
         <a routerLink="/login" class="btn btn-success btn-custom">Login</a>
         <a routerLink="/cadastrar" class="btn btn-success btn-custom">Registrar</a>
      </div>
...
export class App implements OnInit, OnDestroy {
  ...
  private checkRoute(url: string) {
    ...
    const hideHeaderRoutes = ['/login', '/cadastrar', '/senha'];
    this.showHeader = !hideHeaderRoutes.some(route => url.startsWith(route));
  }
}
